...
/* 컬랙션 프레임 워크 : 데이터 분을 저장하는 클래스들을 표준화한 설계
 ...
 * 
 * 
 *   List(인터페이스) : 순서가 있는 데이터들의 집합(데이터의 중복 허용)
 *     구현 클래스 - ArrayList, LinkedList, Stack, Vector......
 *     고정 크기 => 크기변경이 필요하다면 내부적으러 알아서 처리해줌
 * 
 *    ==> 배열과 동일한 개념
...
public class ArrayListEx {
  ...
  public static void main(String[] args) {
    ...
    list2.add("Java"); // append 개념 (차례대로 뒤에 추가)
    list2.add("JSP");
    list2.add("HTML");
    list2.add("CSS");
    ...
    // 메소드
    // arr.length()
    System.out.println("size() " + list2.size()); // ArrayList 에 저장된 객체 갯수
    // arr[3]
    ...
    list2.set(1, "Oracle"); // 특정 위치에 객체 추가 (중간 삽입 개념)
    System.out.println(list2);
  }
}
