...
//        적은 양의 코드로 새로운 클래스를 작성할수 있고 코드를 공통적으로 관리하기 때문에 코드의
//        추가 및 변경에 용이함 => 코드의 재사용성 증가 및 중복 제거
//        자손 클래스는 보상 클래스의 보든걸 상속
//        생성자와 초기화 블럭은 상속되지 않음
//        단일 상속만 가능
//        모든 클래스는 Object 클래스를 상속받는다
//        오버라이딩
//        - 부모의 메소드와 동일한 시그니처(리턴타입,메소드명,인자)를 가진다
//        = 오버라이딩 메소드는 부모보다 접근 제한자를 좁게 가져가서는 안됨
